...
역시 너무 간단하고.. 보일러플레이트가 거의 0에 수렴하도록 만들어놨다는 것이 인상적이다.
...
약간 이래도 되나ㅋ 싶은 부분도 있고, 빅3에 비하면 미래가 아직은 불투명하다는 점이 있지만, 어쨌든 굉장히 매력적인 데가 있고, 특히 생산성이 매우 좋을 것 같다. 일단 벌써부터 Vue가 약간 오징어로 보이는..
