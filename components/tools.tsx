...
import { BoxVariant } from "./box-drawn.tsx";

/**
 * # `stringDigger`⛏️
 *
 * Extract text from children
 * @param {Preact.ReactNode} children
 * @returns {string} The text from children
 */
export function stringDigger(children: Preact.ComponentChildren): string {
    if (Array.isArray(children)) {
        return children.map(stringDigger).join(" ");
    }

    if (
        Preact.isValidElement(children) && children.props.children !== undefined
    ) {
