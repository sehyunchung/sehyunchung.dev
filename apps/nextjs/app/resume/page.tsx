			...
			>
				...
				<div className="row-start-2 col-start-1 col-span-7 h-min pr-6">
					...
					<WorkExperienceShortItem
						...
						period="2020. 12 ~ 현재"
						description="초기에 합류하여 서비스 및 어드민 등 프론트엔드 개발이 필요한 모든 부분의 개발에 참여 및 리딩했고, 기술 리서치 및 적용, 문서화, 미팅 방식 개발, 회고 프로세스 도입, 신입 개발자 온보딩 프로그램 개발 등 팀 경험 개선 및 조직 문화를 만드는 데에도 주도적인 역할을 하고 있습니다."
					/>
