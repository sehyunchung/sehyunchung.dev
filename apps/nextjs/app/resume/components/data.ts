...
export const WORK_EXPERIENCE = [
	{
		...
		achievements: [
			...
			"기술 선택, 개발 방식, 메인터너블한 코드 구조 등에 대한 이해도를 높였습니다.",
		...
		shortcomings: [
			"넓은 범위에 능력이 있고 기여가 가능하다는 사실을 좀 더 빨리 알았다면, 보다 적극적으로 기여가 가능한 환경이었다면 어땠을까 하는 아쉬움이 있습니다.",
		],
	},
	{
		company: "(주) 버드뷰",
		...
		achievements: [
			...
			"jquery 등으로 이루어져있는 레거시 프로젝트를 유지보수하며 DOM API에 대한 이해도를 높였습니다.",
